================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : MEXSample Project Overview
===============================================================================

The application wizard has created this MEXSample application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your MEXSample application.
...
MEXSample.h
    ...
    CMEXSampleApp application class.
...
res\MEXSample.ico
    ...
    icon is included by the main resource file MEXSample.rc.
...
MEXSampleDlg.h, MEXSampleDlg.cpp - the dialog
    These files contain your CMEXSampleDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in MEXSample.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CMEXSampleDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named MEXSample.pch and a precompiled types file named StdAfx.obj.
