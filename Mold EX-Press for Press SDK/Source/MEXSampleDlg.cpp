...
// 	5: 泰文TAI
	...
	combo->AddString(_T("SAT&X_T-[oInit:2]"));
	...
	int iInit = 2;
	{
		...
		DWORD dwSize = 256;
		GetPrivateProfileString(szSection,szKey,_T("2"),szInit.GetBuffer(dwSize),dwSize,m_szSettingFile);
		iInit = _ttoi(szInit);
	...
	{
		CString szID;
		szID.Format(_T("IDS_GPL_LISTCTRL_R0C%d"), i);
		lvColumn.iSubItem = i;
...
//	m_szGPLPath = _wgetenv(_T("Misumi_Path_GPL"));
	...
	HKEY hKey = NULL;
	long lRet= RegOpenKeyEx(HKEY_CLASSES_ROOT, _T("Mold_EX_Press_Global_P.Out\\CLSID"), 0, KEY_READ, &hKey);
...
//	AfxMessageBox(m_szGMLPath);
	...
	WritePrivateProfileString(szSection,szKey,m_szGPLPath,m_szSettingFile);
	...
	if (szModelFilePath == _T(""))
	{
		if (m_szGPLPath != _T(""))
		{
			szModelFilePath = m_szGPLPath + _T("Preview\\dwgtmp\\");
		}
		else
		{
			szModelFilePath = _T("");
	...
	if (szPropertyFilePath == _T(""))
	{
		if (m_szGPLPath != _T(""))
		{
			szPropertyFilePath = m_szGPLPath + _T("Preview\\dwgtmp\\");
		}
		else
		{
	...
	//Read CSV
	csv::Parser file = csv::Parser(L"Custom_info_GPL.csv");
...
void CMEXSampleDlg::UpdateInterfaceLang()
{
	...
	SetWindowText(g_LoadString(_T("IDS_GPL_DLG_TITLE"), szLanguagePath));
	GetDlgItem(IDC_STATIC_MODULE_INIT)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_1"), szLanguagePath));
	GetDlgItem(IDC_BUTTON_MODULE_INIT)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_2"), szLanguagePath));
	GetDlgItem(IDC_STATIC_LANG_SETTING)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_3"), szLanguagePath));
	GetDlgItem(IDC_STATIC_IMPORT_SETTING)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_5"), szLanguagePath));
	GetDlgItem(IDC_BUTTON_RUN)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_6"), szLanguagePath));
	GetDlgItem(IDC_STATIC_MODIFY)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_7"), szLanguagePath));
	GetDlgItem(IDC_STATIC_MODIFY_STRING)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_8"), szLanguagePath));
	GetDlgItem(IDC_BUTTON_MODIFY)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_9"), szLanguagePath));
	GetDlgItem(IDC_STATIC_BOM)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_10"), szLanguagePath));
	GetDlgItem(IDC_STATIC_BOM_NUMBER)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_11"), szLanguagePath));
	GetDlgItem(IDC_CHECK_CLEAR_EXISTING_BOM)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_12"), szLanguagePath));
	GetDlgItem(IDC_STATIC_BOM_STRING)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_13"), szLanguagePath));
	GetDlgItem(IDC_BUTTON_BOM)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_14"), szLanguagePath));
	GetDlgItem(IDC_STATIC_FILE_PATH)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_15"), szLanguagePath));
	GetDlgItem(IDC_STATIC_MODEL_FILE)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_16"), szLanguagePath));
	GetDlgItem(IDC_STATIC_PROPERTY_FILE)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_17"), szLanguagePath));
	GetDlgItem(IDC_STATIC_AUTO_OPEN)->SetWindowText(g_LoadString(_T("IDS_GPL_DLG_19"), szLanguagePath));
	Invalidate(true);
}
...
void CMEXSampleDlg::UpdateMainLang()
{
	...
	strMainName = g_LoadString(_T("IDS_GPL_1"), szLanguagePath);
	strMainName += _T("-[oShowInterfaceDlg1:0]");
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_2"), szLanguagePath);
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_3"), szLanguagePath);
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_4"), szLanguagePath);
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_5"), szLanguagePath);
	strMainName += _T("-[oShowInterfaceDlg1:1]");
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_6"), szLanguagePath);
	strMainName += _T("-[oShowInterfaceDlg1:2]");
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_7"), szLanguagePath);
	strMainName += _T("-[oShowInterfaceDlg1:3]");
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_8"), szLanguagePath);
	strMainName += _T("-[oShowInterfaceDlg1:4]");
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_9"), szLanguagePath);
	strMainName += _T("-[oShowInterfaceDlg1:5]");
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_13"), szLanguagePath);
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_14"), szLanguagePath);
	m_comboMain.AddString(strMainName);

	strMainName = g_LoadString(_T("IDS_GPL_15"), szLanguagePath);
	strMainName += _T("-[oShowDlg_Menu:30]");
	m_comboMain.AddString(strMainName);
...
{
	// TODO: Add your control notification handler code here
	if(!m_szGPLPath.GetLength() ||!m_iOut.CreateDispatch(_T("Mold_EX_Press_Global_P.Out")))
	{
		AfxMessageBox(g_LoadString(_T("IDS_GPL_CREATE_DISPATCH_FAIL"), GetLanguagePath()));
		return;
	}
...
//	m_szGPLPath = _wgetenv(_T("Misumi_Path_GPL"));
	...
	AfxMessageBox(g_LoadString(_T("IDS_GPL_INIT_SUCCESS"), GetLanguagePath()));
}
...
void CMEXSampleDlg::OnCbnSelchangeComboMain()
{
	...
	case 1:
		...
		strSubName = g_LoadString(_T("IDS_GPL_2_1"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:0]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_2"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:1]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_3"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:2]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_4"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:3]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_5"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:4]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_6"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:5]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_7"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:6]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_8"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:7]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_9"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:8]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_10"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:9]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_11"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:10]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_2_12"), szLanguagePath);
	...
	case 2:
		...
		strSubName = g_LoadString(_T("IDS_GPL_3_1"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:12]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_3_2"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:13]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_3_3"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:14]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_3_4"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:15]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_3_5"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:16]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_3_6"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:17]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_3_7"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:18]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_3_8"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:19]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_3_9"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:20]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_3_10"), szLanguagePath);
	...
	case 3:
		...
		strSubName = g_LoadString(_T("IDS_GPL_4_1"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:22]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_2"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:23]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_3"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:24]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_4"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:25]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_5"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:26]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_6"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:27]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_7"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:28]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_8"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:29]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_9"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:30]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_10"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:31]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_11"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:32]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_12"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:33]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_13"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:34]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_14"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:35]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_4_15"), szLanguagePath);
		strSubName += _T("-[oShowInterfaceDlg2:36]");
		m_comboSub.AddString(strSubName);
	...
	case 9:
		...
		strSubName = g_LoadString(_T("IDS_GPL_13_1"), szLanguagePath);
		strSubName += _T("-[oShowDlg_Menu:0]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_13_2"), szLanguagePath);
		strSubName += _T("-[oShowDlg_Menu:1]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_13_3"), szLanguagePath);
		strSubName += _T("-[oShowDlg_Menu:2]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_13_4"), szLanguagePath);
		strSubName += _T("-[oShowDlg_Menu:3]");
		m_comboSub.AddString(strSubName);
	...
	case 10:
		...
		strSubName = g_LoadString(_T("IDS_GPL_14_1"), szLanguagePath);
		strSubName += _T("-[oShowDlg_Menu:4]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_14_2"), szLanguagePath);
		strSubName += _T("-[oShowDlg_Menu:5]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_14_3"), szLanguagePath);
		strSubName += _T("-[oShowDlg_Menu:6]");
		m_comboSub.AddString(strSubName);

		strSubName = g_LoadString(_T("IDS_GPL_14_4"), szLanguagePath);
		strSubName += _T("-[oShowDlg_Menu:7]");
		m_comboSub.AddString(strSubName);
...
void CMEXSampleDlg::GenerateModel()
{
	...
	CopyFile(m_szGPLPath+_T("Preview\\dwgtmp\\msmdwgtmp.sat"), szModelFilePath+_T("msmdwgtmp.sat"), FALSE);
	...
	if (init==1)
	{
		CopyFile(m_szGPLPath+_T("Preview\\dwg\\")+strOrder+_T(".dwg"), szModelFilePath+strOrder+_T(".dwg"), FALSE);
		CopyFile(m_szGPLPath+_T("Preview\\dwg\\")+strOrder+_T("_1.dwg"), szModelFilePath+strOrder+_T("_1.dwg"), FALSE);
		CopyFile(m_szGPLPath+_T("Preview\\dwg\\")+strOrder+_T("_2.dwg"), szModelFilePath+strOrder+_T("_2.dwg"), FALSE);
		CopyFile(m_szGPLPath+_T("Preview\\dwg\\")+strOrder+_T("_3.dwg"), szModelFilePath+strOrder+_T("_3.dwg"), FALSE);
	}
	else if (init==2)
	{
		CopyFile(m_szGPLPath+_T("Preview\\dwgtmp\\msmparasolidfile.x_t"), szModelFilePath+_T("msmparasolidfile.x_t"), FALSE);
	}
	else if (init==5)
	{
		CopyFile(m_szGPLPath+_T("Preview\\dwgtmp\\msmstpfile_prt.stp"), szModelFilePath+_T("msmstpfile_prt.stp"), FALSE);
	}
	else if (init==6)
	{
		CopyFile(m_szGPLPath+_T("Preview\\dwg\\")+strOrder+_T(".dwg"), szModelFilePath+strOrder+_T(".dwg"), FALSE);
	...
	CString szInfo1 = g_LoadString(_T("IDS_GPL_MODEL_SAVED_PATH"), GetLanguagePath()) + _T("\n");
	szInfo1 += _T("<a>");//
	...
	{
		szInfo1 += _T("|msmparasolidfile.x_t");
	}
	else if (init==5)
	{
	...
	CString szInfo2 = g_LoadString(_T("IDS_GPL_ATTRIBUTE_DUMPED_FILE"), GetLanguagePath()) + _T("\n");
	szInfo2 += _T("<a>");
...
void CMEXSampleDlg::OnBnClickedButtonRun()
{
	...
	case 2:
		{
			int index2 = m_comboSub.GetCurSel();
			RunInterfaceDlg2(index2+12);
		}
		break;
	case 3:
		{
			int index2 = m_comboSub.GetCurSel();
			RunInterfaceDlg2(index2+22);
		}
		break;
	case 4:
		{
	...
	case 9:
		{
			int index2 = m_comboSub.GetCurSel();
			m_iOut.oShowDlg_Menu(index2);
		}
		break;
	case 10:
		{
			int index2 = m_comboSub.GetCurSel();
			m_iOut.oShowDlg_Menu(index2+4);
		}
		break;
	case 11:
		{
			m_iOut.oShowDlg_Menu(30);
		}
		break;
	}
...
void CMEXSampleDlg::OnNMClickSyslinkHelp(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: Add your control notification handler code here
	CString szLanguagePath = GetLanguagePath();
	::HtmlHelp(NULL, g_LoadString(_T("IDS_GPL_LINK_HELP"), szLanguagePath), HH_DISPLAY_TOPIC, 0); 
}
...
void CMEXSampleDlg::OnNMClickSyslink1(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: Add your control notification handler code here
	CString szLanguagePath = GetLanguagePath();
	::HtmlHelp(NULL, g_LoadString(_T("IDS_GPL_LINK_1"), szLanguagePath), HH_DISPLAY_TOPIC, 0); 
}
...
void CMEXSampleDlg::OnNMClickSyslink2(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: Add your control notification handler code here
	CString szLanguagePath = GetLanguagePath();
	::HtmlHelp(NULL, g_LoadString(_T("IDS_GPL_LINK_2"), szLanguagePath), HH_DISPLAY_TOPIC, 0); 
}
...
void CMEXSampleDlg::OnNMClickSyslink3(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: Add your control notification handler code here
	CString szLanguagePath = GetLanguagePath();
	::HtmlHelp(NULL, g_LoadString(_T("IDS_GPL_LINK_3"), szLanguagePath), HH_DISPLAY_TOPIC, 0); 
}
...
void CMEXSampleDlg::OnNMClickSyslink4(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: Add your control notification handler code here
	CString szLanguagePath = GetLanguagePath();
	::HtmlHelp(NULL, g_LoadString(_T("IDS_GPL_LINK_4"), szLanguagePath), HH_DISPLAY_TOPIC, 0); 
}
...
{  
	...
	CString szLanguagePath = GetLanguagePath();
	CString szTitle = g_LoadString(_T("IDS_GPL_DLG_18"), szLanguagePath);
